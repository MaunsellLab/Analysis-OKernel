function limits = setLimits(theSubset)
  ...
  limits.minDec = -1;
  limits.minDPrime = -1;
  limits.minAvgDeltaDPrime = -1; % Use this to control stringency for data selection
  limits.minSessionDeltaDPrime = -1; % Single Session Delta d-prime must exceed this for inclusion 
